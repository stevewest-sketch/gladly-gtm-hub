...
export default function ContentHub({
  ...
  const mostUsed = useMemo(() => {
    return [...entries].sort((a, b) => (b.viewCount || 0) - (a.viewCount || 0)).slice(0, 5);
  }, [entries]);
  ...
  const filteredEntries = useMemo(() => {
    ...
    return result;
  }, [entries, activeTypeFilter, activeProductFilters, templatesOnly, searchQuery, sortBy]);
  ...
  const renderDiscoveryItem = (entry: CatalogEntry, showViews = false) => {
    ...
    return (
      <div
        ...
        className="flex items-center gap-3 py-3 border-b border-gray-100 last:border-b-0 cursor-pointer transition-all hover:bg-gray-50 hover:-mx-3 hover:px-3 hover:rounded-md"
      >
    ...
    <div className="min-h-screen bg-[#F8F9FC]">
      ...
      <main className="max-w-[1400px] mx-auto px-8 py-8">
        {activeTab === 'all' ? (
          <>
            {/* Discovery Section */}
            <section className="bg-gradient-to-br from-purple-50 via-white to-violet-50 rounded-2xl p-8 mb-10 border border-purple-100/50">
              <div className="grid grid-cols-2 gap-12">
                ...
                <div>
                  ...
                  <div className="flex flex-col bg-white/70 rounded-xl p-3 backdrop-blur-sm">
                    {mostUsed.map((entry) => renderDiscoveryItem(entry, true))}
                  </div>
                </div>
              </div>
            </section>
            ...
            {/* Search */}
            <div className="mb-6">
              <div className="flex items-center gap-2 px-4 py-3 bg-white border border-gray-200 rounded-lg max-w-md focus-within:border-purple-500 focus-within:ring-2 focus-within:ring-purple-100 transition-all">
