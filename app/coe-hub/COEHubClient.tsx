...
export default function COEHubClient({ hubData }: COEHubClientProps) {
  ...
  const getFilterForButton = () => {
    ...
    return filter?.coeCategory ? { coeCategory: filter.coeCategory } : {}
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white">
      ...
      {hubData.showCatalog && (
        <UniversalCatalogSection
          title={`${hubData.catalogTitle} ${activeButtonData?.label} Resources`}
