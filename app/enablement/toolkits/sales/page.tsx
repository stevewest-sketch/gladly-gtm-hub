...
import { salesToolkitData } from '@/config/toolkits/sales';

export default function SalesToolkitPage() {
  const { hero, banner, primaryActions, quickLinks, browseCategories } = salesToolkitData;
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[1200px] mx-auto px-10 py-12">
        ...
        <ToolkitSection
          ...
          subtitle="Explore by sales stage, product, or content type"
        >
